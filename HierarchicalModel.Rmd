...
Below is a summary of the simple linear five-predictor pooled model.
...
The effective sample size in the Hierarchical Model is at least 3000 for each parameter, which is plenty!

### Rhat convergence
All of the models have r hat values of 1.0, so the HMC chains were both convergent and independent. 
