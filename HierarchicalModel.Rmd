...
# fit_lm_1 <- stan_glmer(lrscale ~ gincdif | country[sample_rows], data=sample_data_best_vars, prior = t_prior, prior_intercept = t_prior)

# fit_hier_1 <- stan_lmer(lrscale ~ gincdif + (1 | country), data=sample_data_best_vars)
fit_hier_1 <- stan_lmer(lrscale ~ 1 + gincdif + (1 | country), data=sample_data_best_vars)
# fit_hier_1 <- stan_glm(lrscale ~ gincdif, data=sample_data_best_vars)
